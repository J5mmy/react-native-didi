...
const BUNDLE_ID = 'com.didi'; // ios bundle id
const PACKAGE = 'com.didi'; // android package name
const NAME = 'DidiApp'; // app name
const EXPO_ACCOUNT_OWNER = 'j5mmy'; // expo account owner
const EAS_PROJECT_ID = '88df3b96-005e-4bb3-96fd-a624c9e0bfa1'; // eas project id
const SCHEME = 'didiApp'; // app scheme
